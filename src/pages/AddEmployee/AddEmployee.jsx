                ...
                >
                    <div style={styles.formContent}>
                        ...
                        <Row style={styles.formRow}>
                            ...
                            <Col l="5">
                                <FormBinder name="name" required message="必填项">
                                    <Input name="name" placeholder="淘小宝" style={{ width: '300px' }} />
                                </FormBinder>
                        ...
                        <Row style={styles.formRow}>
                            ...
                            <Col l="5">
                                <FormBinder type="email" name="email" required message="请输入正确的邮箱">
                                    <Input maxLength={20} placeholder="邮箱" style={{ width: '300px' }} />
                                </FormBinder>
                                <div style={styles.formErrorWrapper}>
